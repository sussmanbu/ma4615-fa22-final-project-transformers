...
### Linear Model using Year, Age Group, and Political Affiliation as Predictors for Abortion Rates
...
AbortionRateMod1 <- 
 ...
 AbortionRateData %>%
   ...
   labs(title = 'Average Abortion Rate from 1973 to 2017', x = '\nYear', y = 'Average Abortion Rate\n', color = "Age Group") + 
   ggthemes::theme_economist() +
   theme(legend.position = 'right', legend.text = element_text(size = 8)) + 
   scale_color_viridis_d(option = "plasma")
```
...
```{r}
AbortionRateMod2 <- 
   lm(AverageAbortionRate ~ Affiliation * year + Age, data = AvgAbortionRateData)
