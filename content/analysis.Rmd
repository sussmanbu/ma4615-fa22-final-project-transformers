...
abortionDataClean %>% 
  ...
  labs(title = 'Graph 1. Average Abortion Rate by State Affiliation', x = 'State\n', y = '\nAverage Abortion Rate', fill = "Affliation") + 
...
abortionDataClean %>% 
  ...
  coord_flip() + 
  scale_fill_manual(values = c('#00214d', '#7c7b78', '#e91515')) + 
  labs(title = 'Graph 2. Average Pregnancy Rate by State Affiliation', x = 'State\n', y = '\nAverage Pregnancy Rate', fill = "Affliation") + 
  ggthemes::theme_economist() +
  theme(axis.text.y = element_text(size = 7), axis.title = element_text(size = 10), legend.position = 'right', legend.text = element_text(size = 8))
```
...
abortionDataClean %>% 
  ...
  geom_line() + 
  labs(title = 'Graph 3. Average Pregnancy Rate by Age Group from 1973 to 2017', x = 'Year', y = 'Average Pregnancy Rate', color = "Age Group") + 
  ggthemes::theme_economist() +
...
abortionDataClean %>% 
  ...
  geom_line() + 
  labs(title = 'Graph 4. Average Abortion Rate by Age Group from 1973 to 2017', x = 'Year', y = 'Average Abortion Rate', color = "Age Group") + 
  ggthemes::theme_economist() +
  theme(legend.position = 'right', legend.text = element_text(size = 8)) +
  scale_color_viridis_d(option = "turbo")
```
...
abortionDataClean %>% 
  ...
  labs(title = 'Graph 5. Average Pregnancy Rate by Age Group for Different Political Affiliations', x = 'Year', y = 'Average Pregnancy Rate', color = "Age Group")
```
...
abortionDataClean %>% 
  ...
  geom_point(alpha = .3) + 
  facet_wrap(~ as.factor(Affiliation)) +
  labs(title = 'Graph 6. Average Abortion Rate by Age Group for Different Political Affiliations', x = 'Year', y = 'Average Abortion Rate', color = "Age Group")
```
