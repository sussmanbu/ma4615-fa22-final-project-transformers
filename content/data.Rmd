...
2. For each year and each state, we compared the percentage of people who voted for the Democrat and the Republican candidate. If the difference in the percentages was greater than or equal to 0.1%, then the party with more votes is selected as the dominating political party for that state. Otherwise, that state is considered to be divided for that year.
